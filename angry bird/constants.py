...
BLUEBIRD = pygame.transform.scale(pygame.image.load("assets/images/blue-bird.png").convert_alpha() , (40 , 40))
YELLOWBIRD = pygame.transform.scale(pygame.image.load("assets/images/yellow-bird.png" ).convert_alpha() , (40 , 40))
BLACKBIRD = pygame.transform.scale(pygame.image.load("assets/images/black-bird.png").convert_alpha() , (60 , 60))
EXTRALARGEBIRD = pygame.transform.scale(pygame.image.load("assets/images/extra-large-bird.png").convert_alpha() , (80 , 80))

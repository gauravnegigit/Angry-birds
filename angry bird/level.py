...
class Level :
    ...
    def build_2(self):
        ...
        self.columns.append(Polygon(p , 20 , 20 , self.space))
    ...
    def build_8(self):
        ...
        pig.life = 30
        self.pigs.append(pig)
        pig = Pig(1078, HEIGHT - 280, self.space)
        pig.life = 30
        self.pigs.append(pig)
        pig = Pig(900, HEIGHT - 80, self.space)
        pig.life = 30
        self.pigs.append(pig)
    ...
    def build_10(self):
        """level 10"""
        pig = Pig(960, HEIGHT - 250, self.space)
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(820, HEIGHT - 160, self.space)
        self.pigs.append(pig)
        pig = Pig(1100, HEIGHT - 160, self.space)
        self.pigs.append(pig)
    ...
    def build_11(self):
        """level 11"""
        pig = Pig(820, HEIGHT - 177, self.space)
        self.pigs.append(pig)
        pig = Pig(960, HEIGHT - 150, self.space)
        self.pigs.append(pig)
        pig = Pig(1100, HEIGHT - 130, self.space)
        self.pigs.append(pig)
        pig = Pig(890, HEIGHT - 270, self.space)
        pig.life = 30
        self.pigs.append(pig)
